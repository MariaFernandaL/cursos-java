package co.edu.cue.programacion2.application;
...
//		bufferReaderYWriter_V3();
	...
	/*private static void fileReaderYWriter_V1(){
		try {
			FileWriter fw= new FileWriter("C://td//directorioPrueba//fichero.txt",true);
		
			fw.write("hola esto son pruebas");
			fw.write(69);
		
			fw.close();
			
			FileReader fr= new FileReader("C://td//directorioPrueba//fichero.txt");
